...
def rank_zones_for_side(
    ...
    for z in zones:
        ...
        z2["source_types_label"] = ",".join(sorted(z.get("source_types", set())))
        z2.update(reaction)
    ...
    try:
        ...
        col2.metric(
            ...
            (
                ...
                f" [{nearest_res.get('timeframe_sources', '')}]"
        ...
        col3.metric(
            ...
            (
                ...
                f" [{nearest_sup.get('timeframe_sources', '')}]"
